...
if [ ! -f "$UNREAL_ENGINE_PATH/Engine/Binaries/ThirdParty/Python3/Win64/lib/python311.dll" ]; then
...
./b2 install --with-python --user-config="$ROOT_DIR/Source/rclcpp/boost_user_configs/boost-user-config-windows.jam" -d0
...
./Engine/Binaries/ThirdParty/Python3/Win64/python.exe -m venv "$ROOT_DIR/Builds/rclcpp/venv"
...
mkdir -p "$ROOT_DIR/Builds/rclcpp/Windows"
...
colcon build --packages-skip-by-dep python_qt_binding --packages-skip Boost OpenCV  \
 --build-base "$ROOT_DIR/Builds/rclcpp/Windows" \
 --merge-install \
 ...
 " -DPython3_EXECUTABLE='$ROOT_DIR/Builds/rclcpp/venv/bin/python'" \
 " -DPython3_LIBRARY='$UNREAL_ENGINE_PATH/Engine/Binaries/ThirdParty/Python3/Win64/python311.dll'" \
 " -DPython3_INCLUDE_DIR='$UNREAL_ENGINE_PATH/Engine/Source/ThirdParty/Python3/Win64/include'" \
 " -DPYTHON_LIBRARY='$UNREAL_ENGINE_PATH/Engine/Binaries/ThirdParty/Python3/Win64/python311.dll'" \
 " -DPYTHON_INCLUDE_DIR='$UNREAL_ENGINE_PATH/Engine/Source/ThirdParty/Python3/Win64/include'" \
 " -DCMAKE_CXX_FLAGS=-isystem '$UNREAL_ENGINE_PATH/Engine/Source/ThirdParty/Python3/Win64/include' -Wno-unused-command-line-argument -Wno-error=unused-command-line-argument" \
 " -DCMAKE_C_FLAGS=-isystem '$UNREAL_ENGINE_PATH/Engine/Source/ThirdParty/Python3/Win64/include' -Wno-unused-command-line-argument -Wno-error=unused-command-line-argument" \
 " --no-warn-unused-cli"
...
# Copy the libraries
find "$ROOT_DIR/Source/rclcpp/install" -name "*.dylib" -exec cp -P {} "$DEST/Libraries/Windows" \;

# Copy the Python deps
cp -r -P "$ROOT_DIR/Source/rclcpp/install/lib/python"* "$DEST/Libraries/Windows"

# Copy the "share" folder
cp -r -P "$ROOT_DIR/Source/rclcpp/install/share" "$DEST/Libraries/Windows"
